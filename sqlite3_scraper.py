...
In the beggining there was a humble sqlite server

(That was the first version of the index database)

That is long gone now, but this file remains for the simple logic it contains and the history is preserves
"""
